...
// echo "Session ".$_SESSION['GePlaDoc_IdUser']."<br>";	

if (isset($_SESSION['GePlaDoc_IdUser'])){
	// echo "Si hay session ".$_SESSION['GePlaDoc_IdUser'];
	// session_regenerate_id();
	$GePlaDoc_IdUser = $_SESSION['GePlaDoc_IdUser'];
	$GePlaDoc_IdUserName = $_SESSION['GePlaDoc_IdUserName'];
