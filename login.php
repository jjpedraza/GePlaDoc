            ...
            // echo "OK";
                ...
                if ($f = $rc->fetch_array()) {
                    ...
                    if ($f['NIP'] == $txtNIP) {
                        ...
                        // session_start();                        
                        $_SESSION['GePlaDoc_IdUser'] = $f['IdUser']; //session		
                        $_SESSION['GePlaDoc_IdUserName'] = $f['UserName']; //session		
                        $GePlaDoc_IdUser = $f['IdUser'];
                        
                        
                        // echo "Sesion=".$_SESSION['GePlaDoc_IdUser']." username=".$_SESSION['GePlaDoc_IdUserName'];

                        // Historia($GePlaDoc_IdUser, 'RinteraLogin', 'Acceso Rintera' . InfoEquipo() . '');
                        // SESSION_init(session_id(), $GePlaDoc_IdUser, $SesionName, InfoEquipo(), "");
